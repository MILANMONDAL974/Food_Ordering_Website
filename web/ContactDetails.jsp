...
<html>
    <head>
        ...
        <title>Displaying all contact details</title>
        <%!
    ...
    <body>
        <div>
            <span style="color: white; font-weight: bold; font-size: 150%"> *** REVIEW ***</span>
            </br>
            </br>
            <span>
                <form method="POST" action="ContactDetails.jsp">
                    <input type="text" placeholder="&#128269;Enter Username" name="tSearch" class="inputbox" required>
        ...
        %>
        <form method="POST" action="ContactDetails.jsp">
            <button type="submit">Display all Contacts </button>
        </form>
        <%                        } else {
