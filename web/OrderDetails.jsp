...
<html>
    <head>
        ...
        <title>Displaying all order details</title>
        <%!
        ...
        <style>
            body {
                margin: 0;
                background: linear-gradient(45deg, #5f2c82, black);
    ...
    <body>
        <div>
            <span style="color: white; font-weight: bold; font-size: 150%"> *** ORDER DETAILS ***</span>
            </br>
            </br>
            <span>
                <form method="POST" action="OrderDetails.jsp">
                    <input type="text" placeholder="&#128269;Enter Order ID" name="tSearch" class="inputbox" required>
        ...
        %>
        <form method="POST" action="OrderDetails.jsp">
            <button type="submit">Display all Orders </button>
        </form>
        <%                        } else {
                ...
                //STEP 4: CREATING THE QUERY
                q = "select * from ORDERS order by 1";
        ...
        <table class="center">
            ...
            <form method="POST" action="http://localhost:8080/Restaurantweb/DelContact?name=<%=ors.getString(1)%>"  onsubmit=" return funDelete()">
