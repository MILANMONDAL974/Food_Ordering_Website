...
<html>
    ...
    <body>
        <div>
            <span style="color: white; font-weight: bold; font-size: 150%"> *** USERS DETAILS ***</span>
            </br>
            </br>
            <span>
        ...
        <table class="center">
            ...
            <form method="POST" action="http://localhost:8080/Restaurantweb/DelUser?tusername=<%=ors.getString(1)%>"  onsubmit=" return funDelete()">
